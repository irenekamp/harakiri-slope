...
#### Je startniveau:
Roestrood op weg naar zwart!
 
#### Je focus:
Ik vond blingbling wel aardig klinken, dus ik denk surface (maar vind responsive ook wel interessant...)
</details>
...
En soms moet er een pop up komen (of whatever; ergens moet er informatie komen, ik zie wel waar) waar je meer informatie kunt lezen of zien (in een plaatje) en ik wil een spelletje: soort random generator met 4 verschillende items (en per item x-aantal opties), zoiets als hier (maar dan mooier) https://bryangalera.com/tarot.php?c=ROzBGwKePwPyPutlzzzzp. 
 ...
 Oh ja en! ik wil graag beestjes of buitenaardsewezentjes die geen functie hebben op random plaatsen op de kaart (en als je er op klikt gebeuren er random dingen - zegt t "hoi" of wordt ie plat geslagen etc. Is dat te veel? Na ja, we zien wel waar we uitkomen...). 
</details>
